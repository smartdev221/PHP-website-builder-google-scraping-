...
class Diff{
  ...
  public static function compare(
    ...
    if ($compareCharacters){
      ...
      $sequence1 = preg_split('/\s/', $string1);
      $sequence2 = preg_split('/\s/', $string2);
    ...
    // return the diff
    return array($diff, count($sequence2));
   ...
   *                defaults to '<br>'
   */
  public static function toTable($diff, $words, $indentation = '', $separator = '<br>'){
    ...
    while ($index < count($diff)){
      ...
      switch ($diff[$index][1]){
        ...
        case self::UNMODIFIED:			
          ...
          $rightCell = array($leftCell[0]);
		  $match = $match+$leftCell[1];
          break;
    ...
    // return the HTML
    return $html . $indentation . "</table>\n".$match." words were the same from the ".$words." words total(".(($match/$words)*100)."% match).\n";

  }
  public static function toTable1($diff, $words, $indentation = '', $separator = '<br>'){
    ...
    // return the HTML
    return round(($match/$words)*100, 2);
