...
function advert($ftp, $ftpuser, $ftppassword, $website, $conn, $file){
	$success = 0;
...
@keyframes spin {
  ...
  <i style="margin-top:7px;" class="icon-dashboard icon-large"></i>Dashboard</a>
	...
	<li class="active">
      <a href="websites_test.php"><i style="margin-top:7px;" class=" icon-file icon-large"></i>Websites</a>
    </li>
	<li>
...
?>
  ...
  <div class="span6"><div class="widget_heading"><h4>Add Website</h4></div><div class="widget_container">
  ...
  <label class="control-label" for="input01">Name (allowed a-Z, 0-9, -, _) - asd_com; asdCOM; asd; asd-com etc</label>
  <div class="controls">
  ...
  <div class="controls">
    <input type="text" name="ftp" class="input-xlarge span5" value="<?php echo $_SERVER['SERVER_ADDR']; ?>" >
...
<div id="wordpress_url" style="display:block; ">
<label class="control-label" for="input01">Wordpress url (e.g. http://domain.com/) - needed for post and user add</label>
  <div class="controls">
    <input type="text" name="wordpress_url" class="input-xlarge span5" >

</div>
  <label class="control-label" for="input01"><img src="https://icons.iconarchive.com/icons/sicons/basic-round-social/512/wordpress-icon.png" width="32"> Post category(comma delimited)</label>
  <div class="controls">
    <input type="text" name="wordpress_categories" class="input-xlarge span5" >

</div>
<label class="control-label" for="input01"><img src="https://icons.iconarchive.com/icons/sicons/basic-round-social/512/wordpress-icon.png" width="32"> Image chiclets as post_tags</label>
  <div class="controls">
...
<label class="control-label" for="input01"><b>Copy template & other info from website</b></label>
<div class="controls">
	<select name="copy">
		<?php $select_websites = mysqli_query($conn, "SELECT `id`,`name` FROM `websites`");
...
<label class="control-label" for="input01">Serp content not matching intro, cause & fix</label>
  <div class="controls">
...
<hr>
  ...
  <label class="control-label" for="input01">Spin scraped serp content before translation</label>
  <div class="controls">
	<select name="spin">
  ...
  <label class="control-label" for="input01">Use Serp Scraped title (below inputs for title are ignored if Yes)</label>
  <div class="controls">
...
<label class="control-label" for="input01"><b>Keywords CSV (it can't be uploaded later) **********</b></label>
  <div class="controls">
  ...
  <div class="controls">
    <textarea name="template1" class="input-xlarge span5" rows="10" cols="100"></textarea>

</div>
  <label class="control-label" for="input01">Template 2</label>
  <div class="controls">
    <textarea name="template2" class="input-xlarge span5" rows="10" cols="100"></textarea>

</div>
<label class="control-label" for="input01">Template 3</label>
  <div class="controls">
    <textarea name="template3" class="input-xlarge span5" rows="10" cols="100"></textarea>

</div>
<label class="control-label" for="input01">Template 4</label>
  <div class="controls">
    <textarea name="template4" class="input-xlarge span5" rows="10" cols="100"></textarea>

</div>
<label class="control-label" for="input01">Template 5</label>
  <div class="controls">
    <textarea name="template5" class="input-xlarge span5" rows="10" cols="100"></textarea>
...
?>
  ...
  <label class="control-label" for="input01">Name (allowed a-Z, 0-9, -, _) - asd_com; asdCOM; asd; asd-com etc</label>
  <div class="controls">
    <input type="text" name="name" value="<?php echo $row1->name; ?>" disabled class="input-xlarge span5" >
...
<label class="control-label" for="input01">Serp content not matching intro, cause & fix</label>
  <div class="controls">
	<select name="not_matching">
		<option value="1" <?php if($row1->serp_not_matched == 1){ echo "selected"; } ?>>Skip keyword</option>
		<option value="2" <?php if($row1->serp_not_matched == 2){ echo "selected"; } ?>>Use OLD method</option>
		<option value="3" <?php if($row1->serp_not_matched == 3){ echo "selected"; } ?>>Use Random Subheadings method</option>
	</select>
...
<label class="control-label" for="input01">First step</label>
  ...
  ?>
	<select name="step_1" id="step_1">
		...
		<option value="3" <?php if($step_1 == 3){ echo "selected"; } ?>>GTR Google Multi-translation</option>
	</select>
<script>
setTimeout(function(){ 
rewrite_edit('step_1', '<?php echo $step_1_options; ?>','<?php echo $step_1_langs[0]; ?>', '<?php echo $step_1_langs[1]; ?>', '<?php echo $step_1_langs[2]; ?>'); 
}, 1000);
</script>
	<div name="step_1_options">
	</div>
...
<label class="control-label" for="input01">Second step</label>
  ...
  ?>
	<select name="step_2" id="step_2">
		...
		<option value="3" <?php if($step_2 == 3){ echo "selected"; } ?>>GTR Google Multi-translation</option>
	</select>
<script>
setTimeout(function(){ 
rewrite_edit('step_2', '<?php echo $step_2_options; ?>','<?php echo $step_2_langs[0]; ?>', '<?php echo $step_2_langs[1]; ?>', '<?php echo $step_2_langs[2]; ?>'); 
}, 1000);
</script>
	<div name="step_2_options">
	</div>
...
<label class="control-label" for="input01">Third step</label>
  ...
  ?>
	<select name="step_3" id="step_3">
		...
		<option value="3" <?php if($step_3 == 3){ echo "selected"; } ?>>GTR Google Multi-translation</option>
	</select>
<script>
setTimeout(function(){
rewrite_edit('step_3', '<?php echo $step_3_options; ?>','<?php echo $step_3_langs[0]; ?>', '<?php echo $step_3_langs[1]; ?>', '<?php echo $step_3_langs[2]; ?>'); 
}, 1000);
</script>
	<div name="step_3_options">
	</div>
...
<hr>
  <label class="control-label" for="input01">Serp minimum word count</label>
  <div class="controls">
    <input type="text" name="words" value="<?php echo $row1->words; ?>" class="input-xlarge span5" >

</div>
  <label class="control-label" for="input01">Posts per day</label>
  <div class="controls">
    <input type="text" name="perday" value="<?php echo $row1->perday; ?>" class="input-xlarge span5" >

</div>
<?php if(!empty($row1->wordpress_url)){?>
  <label class="control-label" for="input01"><img src="https://icons.iconarchive.com/icons/sicons/basic-round-social/512/wordpress-icon.png" width="32"> Post category(comma delimited)</label>
  <div class="controls">
    <input type="text" name="wordpress_categories" value="<?php echo $row1->wordpress_categories; ?>" class="input-xlarge span5" >

</div>
<label class="control-label" for="input01"><img src="https://icons.iconarchive.com/icons/sicons/basic-round-social/512/wordpress-icon.png" width="32"> Image chiclets as post_tags</label>
  <div class="controls">
	<select name="post_tags">
		<option value="1" <?php if($row1->wordpress_post_tags == 1){ echo "selected"; } ?>>Yes</option>
		<option value="0" <?php if($row1->wordpress_post_tags == 0){ echo "selected"; } ?>>No</option>
	</select>
...
<?php } ?>
  ...
  <div class="controls">
	<select name="spin">
		<option value="0" <?php if($row1->spin == 0){ echo "selected"; } ?>>No spinning</option>
		<option value="1" <?php if($row1->spin == 1){ echo "selected"; } ?>>Every word</option>
		<option value="2" <?php if($row1->spin == 2){ echo "selected"; } ?>>Every 2 words</option>
		<option value="3" <?php if($row1->spin == 3){ echo "selected"; } ?>>Every 3 words</option>
		<option value="4" <?php if($row1->spin == 4){ echo "selected"; } ?>>Every 4 words</option>
		<option value="5" <?php if($row1->spin == 5){ echo "selected"; } ?>>Every 5 words</option>
		<option value="6" <?php if($row1->spin == 6){ echo "selected"; } ?>>Every 6 words</option>
		<option value="7" <?php if($row1->spin == 7){ echo "selected"; } ?>>Every 7 words</option>
		<option value="8" <?php if($row1->spin == 8){ echo "selected"; } ?>>Every 8 words</option>
		<option value="9" <?php if($row1->spin == 9){ echo "selected"; } ?>>Every 9 words</option>
		<option value="10" <?php if($row1->spin == 10){ echo "selected"; } ?>>Every 10 words</option>
	</select>
  ...
  <div class="controls">
	<select name="exclude_paa_title">
		<option value="0" <?php if($row1->exclude_paa_title == 0){ echo "selected"; } ?>>No</option>
		<option value="1" <?php if($row1->exclude_paa_title == 1){ echo "selected"; } ?>>Yes</option>
	</select>
  ...
  <div class="controls">
	<select name="nosnippets">
		<option value="0" <?php if($row1->nosnippets == 0){ echo "selected"; } ?>>No</option>
		<option value="1" <?php if($row1->nosnippets == 1){ echo "selected"; } ?>>Yes</option>
	</select>
  ...
  <div class="controls">
	<select name="serptitle">
		...
		<option value="1" <?php if($row1->serptitle == 1){ echo "selected"; } ?>>Yes</option>
	</select>
  ...
  <label class="control-label" for="input01">Title 1</label>
  <div class="controls">
    <input type="text" name="title1" value="<?php echo $row1->title1; ?>" class="input-xlarge span5" >

</div>
  <label class="control-label" for="input01">Title 2</label>
  <div class="controls">
    <input type="text" name="title2" value="<?php echo $row1->title2; ?>" class="input-xlarge span5" >

</div>
  <label class="control-label" for="input01">Title 3</label>
  <div class="controls">
    <input type="text" name="title3" value="<?php echo $row1->title3; ?>" class="input-xlarge span5" >

</div>
  <label class="control-label" for="input01">Title 4</label>
  <div class="controls">
    <input type="text" name="title4" value="<?php echo $row1->title4; ?>" class="input-xlarge span5" >

</div>
  <label class="control-label" for="input01">Title 5</label>
  <div class="controls">
    <input type="text" name="title5" value="<?php echo $row1->title5; ?>" class="input-xlarge span5" >

</div>
  <label class="control-label" for="input01">Template 1</label>
  <div class="controls">
    <textarea name="template1" class="input-xlarge span5" rows="10" cols="100"><?php echo $row1->template1; ?></textarea>
</div>
<label class="control-label" for="input01">Template 2</label>
  <div class="controls">
    <textarea name="template2" class="input-xlarge span5" rows="10" cols="100"><?php echo $row1->template2; ?></textarea>
</div>
<label class="control-label" for="input01">Template 3</label>
  <div class="controls">
    <textarea name="template3" class="input-xlarge span5" rows="10" cols="100"><?php echo $row1->template3; ?></textarea>
</div>
<label class="control-label" for="input01">Template 4</label>
  <div class="controls">
    <textarea name="template4" class="input-xlarge span5" rows="10" cols="100"><?php echo $row1->template4; ?></textarea>
</div>
<label class="control-label" for="input01">Template 5</label>
  <div class="controls">
    <textarea name="template5" class="input-xlarge span5" rows="10" cols="100"><?php echo $row1->template5; ?></textarea>
</div>
<label class="control-label" for="input01">Find and replace. Use as sitename|siteurl</label>
  <div class="controls">
    <input type="text" name="find_and_replace" value="<?php echo $row1->find_and_replace; ?>" class="input-xlarge span5" >
...
?>
  ...
  <div class="span6"><div class="widget_heading"><h4>Delete Url</h4></div><div class="widget_container">
  <div class="control-group">
  <?php
...
?>
  ...
  <div class="span6"><div class="widget_heading"><h4>Rebuild posts</h4></div><div class="widget_container">
  <div class="control-group">
  <?php
...
?>
  ...
  if($update){
	echo "<span style=\"color: green;font-size:15px;\">This website has been successfully updated.</span><br><br>";
	$website = $_GET['edit'];
	$top = advert($ftp[$website], $ftpuser[$website], $ftppassword[$website], $website, $conn, 1);
	$middle = advert($ftp[$website], $ftpuser[$website], $ftppassword[$website], $website, $conn, 2);
	$bottom = advert($ftp[$website], $ftpuser[$website], $ftppassword[$website], $website, $conn, 3);
  ...
  <div class="controls">
    <textarea name="top" class="input-xlarge span5" rows="10" cols="100"><?php echo $row1->top; ?></textarea>
</div>
  <label class="control-label" for="input01">Display top?</label>
  <div class="controls">
	<select name="top_display">
		<option value="0" <?php if($row1->top_display == 0){ echo "selected"; } ?>>No</option>
		<option value="1" <?php if($row1->top_display == 1){ echo "selected"; } ?>>Yes</option>
	</select>

</div>
<label class="control-label" for="input01">Middle advert</label>
  <div class="controls">
    <textarea name="middle" class="input-xlarge span5" rows="10" cols="100"><?php echo $row1->middle; ?></textarea>
</div>
  <label class="control-label" for="input01">Display middle?</label>
  <div class="controls">
	<select name="middle_display">
		<option value="0" <?php if($row1->middle_display == 0){ echo "selected"; } ?>>No</option>
		<option value="1" <?php if($row1->middle_display == 1){ echo "selected"; } ?>>Yes</option>
	</select>

</div>
<label class="control-label" for="input01">Bottom advert</label>
  <div class="controls">
    <textarea name="bottom" class="input-xlarge span5" rows="10" cols="100"><?php echo $row1->bottom; ?></textarea>
</div>
  <label class="control-label" for="input01">Display bottom?</label>
  <div class="controls">
	<select name="bottom_display">
		<option value="0" <?php if($row1->bottom_display == 0){ echo "selected"; } ?>>No</option>
		<option value="1" <?php if($row1->bottom_display == 1){ echo "selected"; } ?>>Yes</option>
	</select>
...
?>		
		<tr>
			...
			<td><?php echo $row->name; if(!empty($row->wordpress_url)){ echo '<img src="https://icons.iconarchive.com/icons/sicons/basic-round-social/512/wordpress-icon.png" width="32">'; } ?></td>
			<td><?php echo $row->words; ?></td>
			<td><?php echo $row->perday; ?></td>
			<td><a class="btn btn-success" href="websites_test.php?edit=<?php echo $row->id; ?>">Edit</a></td>
			<td><a class="btn btn-danger" href="websites_test.php?rebuild=<?php echo $row->id; ?>">Rebuild</a></td>
...
$(document).ready(function(){
    ...
    $("#button").click(function(){
        ...
        $.get("dbcheck.php", {database: db, username: user, password: pass} , function(data){
	...
	$("#button1").click(function(){
        ...
        $('#loader').show();
        // Send the input data to the server using get
        $.get("ftpcheck.php", {user: ftpuser, password: ftppassword, ip: ftp} , function(data){
            // Display the returned data in browser
