...
if(isset($option)){
	if($option == 1){
?>
<select name="<?php echo $step; ?>_option" id="<?php echo $step; ?>_option">
...
?>
<label>1st language:</label><select id="lang1" name="lang1">
...
<label>2nd language:</label><select id="lang2" name="lang2">
<option value="af">Afrikaans</option>
<option value="sq">Albanian</option>
<option value="am">Amharic</option>
<option value="ar">Arabic</option>
...
<label>3rd language:</label><select id="lang3" name="lang3">
<option value="af">Afrikaans</option>
<option value="sq">Albanian</option>
<option value="am">Amharic</option>
<option value="ar">Arabic</option>
...
<label>3rd -> English (3rd language will be translated back to English)</label>
<?php
	}
